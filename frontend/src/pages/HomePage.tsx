    ...
    <div>
        ...
        <div className="mt-4 grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-base text-slate-600">
              Add your ChatGPT, Claude, Copilot and other tool subscriptions. We’ll calculate spend, detect overlap,
              suggest cheaper plans, and generate a shareable report for decision makers.
            </p>
            ...
            <div className="mt-5 text-xs text-slate-500">
              Deterministic savings engine + optional AI summary (with fallback).
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-sky-100/70 bg-gradient-to-br from-white/70 to-sky-50/70 p-6 shadow-sm">
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-2xl border border-slate-200 bg-white/70 p-4">
                <div className="text-xs font-semibold text-slate-500">Spend visibility</div>
                <div className="mt-2 text-sm font-semibold text-slate-900">Per-tool breakdown</div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white/70 p-4">
                ...
                <div className="mt-2 text-sm font-semibold text-slate-900">$ / month</div>
                <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-slate-200">
              ...
              <div className="col-span-2 rounded-2xl border border-slate-200 bg-white/70 p-4">
                <div className="text-xs font-semibold text-slate-500">Automation feel</div>
                <div className="mt-2 flex items-center justify-between">
                  <div className="text-sm font-semibold text-slate-900">Audit → Insights → Share</div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-sky-100/60 bg-white/60 p-6 shadow-sm backdrop-blur">
          <div className="text-sm font-semibold text-slate-900">Rule-based engine</div>
          <p className="mt-2 text-sm text-slate-600">Explainable recommendations using configurable pricing data.</p>
        </div>
        <div className="rounded-2xl border border-sky-100/60 bg-white/60 p-6 shadow-sm backdrop-blur">
          <div className="text-sm font-semibold text-slate-900">Graph analysis</div>
          <p className="mt-2 text-sm text-slate-600">Recharts visuals to communicate spend and savings quickly.</p>
        </div>
        <div className="rounded-2xl border border-sky-100/60 bg-white/60 p-6 shadow-sm backdrop-blur">
          <div className="text-sm font-semibold text-slate-900">Shareable reports</div>
          <p className="mt-2 text-sm text-slate-600">Public link shows only audit output; no personal data.</p>
        </div>
      </div>
      ...
      <div className="mt-8 rounded-2xl border border-sky-100/60 bg-white/60 p-6 shadow-sm backdrop-blur">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">A simple workflow designed for busy teams.</p>
          </div>
          <a href="/audit" className="text-sm font-semibold text-sky-700 hover:text-sky-800">
            Run it now →
          </a>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-4">
          {[
            ...
            { title: "2. Audit", desc: "Rules compute savings & optimizations." },
            { title: "3. Visualize", desc: "Charts + per-tool rationale." },
            { title: "4. Share", desc: "Public report link for stakeholders." },
          ].map((s, idx) => (
            <div key={s.title} className="relative rounded-2xl border border-slate-200 bg-white/70 p-4">
